...
analisis_muestra <- function(base1,id,var1,var2) {
  ...
  total_act_e <- analisis_total(base=base1,variable={{var2}})
  ...
  dplyr::bind_cols(dplyr::bind_rows(total_act,df_acumulada_act),
                   dplyr::bind_rows(total_act_e,df_acumulada_act_e)) %>%
